...
```bash
python3 -c "
import sys; sys.path.insert(0, '/home/alfernandez/PycharmProjects/strava-coach')
...
```bash
python3 /home/alfernandez/PycharmProjects/strava-coach/scripts/list_activities.py --sync --limit 20
```
...
```bash
python3 /home/alfernandez/PycharmProjects/strava-coach/scripts/get_stats.py --refresh
```
...
```bash
python3 /home/alfernandez/PycharmProjects/strava-coach/scripts/list_activities.py --sync --limit 50 --days 60
```
...
```bash
python3 /home/alfernandez/PycharmProjects/strava-coach/scripts/propose_sessions.py --days 30 --goal "GOAL" --next-days 7
```
