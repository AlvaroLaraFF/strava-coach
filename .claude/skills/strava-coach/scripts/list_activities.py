...
Usage:
    python3 .claude/skills/strava-coach/scripts/list_activities.py [--sync] [--limit 20] [--sport-type Run] [--days 30]
"""
...
def main():
    ...
    parser.add_argument("--dry-run", action="store_true", help="Fetch from API to verify connection but do not persist to DB")
