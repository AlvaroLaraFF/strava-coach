...
python3 -c "
import os
env_path = '/home/alfernandez/PycharmProjects/strava-coach/.env'
...
```bash
python3 /home/alfernandez/PycharmProjects/strava-coach/scripts/list_activities.py --sync --limit 3
```
