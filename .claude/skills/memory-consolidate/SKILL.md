...
description: >
  ...
  whenever the user says "consolida memoria", "review my profile", "update what
  you know about me", "refresh memory".
...
2. **On explicit request** — when the user says "consolida memoria",
   "actualiza mi perfil", "review my profile", "what do you remember about me",
   "refresh memory".
...
```bash
python3 /home/alfernandez/PycharmProjects/strava-coach/.claude/skills/memory-consolidate/scripts/consolidate.py
```
...
Each memory file at
`/home/alfernandez/.claude/projects/-home-alfernandez-PycharmProjects-strava-coach/memory/<name>.md`
