...
python3 /home/alfernandez/PycharmProjects/strava-coach/.claude/skills/strava-sync/scripts/sync.py --level summary

# Force full re-sync of all history (ignores incremental logic)
python3 /home/alfernandez/PycharmProjects/strava-coach/.claude/skills/strava-sync/scripts/sync.py --level summary --full

# Upgrade existing activities to detailed payloads (best_efforts, splits)
python3 /home/alfernandez/PycharmProjects/strava-coach/.claude/skills/strava-sync/scripts/sync.py --level details --limit 50

# Pull streams for runs (for decoupling skill)
python3 /home/alfernandez/PycharmProjects/strava-coach/.claude/skills/strava-sync/scripts/sync.py --level streams --sport Run --limit 20

# Pull athlete zones (HR + power)
python3 /home/alfernandez/PycharmProjects/strava-coach/.claude/skills/strava-sync/scripts/sync.py --level zones

# Everything (slow)
python3 /home/alfernandez/PycharmProjects/strava-coach/.claude/skills/strava-sync/scripts/sync.py --level all
```
...
```bash
python3 /home/alfernandez/PycharmProjects/strava-coach/scripts/setup_oauth.py
```
